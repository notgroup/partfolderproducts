...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <title>Dr. Levine Manyetik Dizlik Seti - levine.bimarketim.info</title>
    ...
    <script src="js/jquery-1.9.1.min.js"></script>
        ...
        <script>
            ...
            fbq('init', '883009068864695');
            fbq('track', 'PageView');
        </script>
        <noscript>
            <img height="1" width="1"
                 src="https://www.facebook.com/tr?id=883009068864695&ev=PageView&noscript=1"/>
        </noscript>
        <!-- End Facebook Pixel Code -->
            <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-150740027-12"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
    
      gtag('config', 'UA-150740027-12');
    </script>
    <!-- Global site tag (gtag.js) - Google Ads: 700350146 -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-700350146"></script>
<script>
window.dataLayer = window.dataLayer || [];
function gtag(){dataLayer.push(arguments);}
gtag('js', new Date());
gtag('config', 'AW-700350146');
</script>
<!-- Event snippet for Satın alma conversion page -->
<script>
gtag('event', 'conversion', {
'send_to': 'AW-700350146/rjFCCL-eusIBEML9-c0C',
'value': ,
'currency': 'TRY',
'transaction_id': ''
});
...
<div class="container" style="background-color: white; width: %100; padding: 0;">
        ...
        <form action="tamamla_post.php" class="thecheckout checkout-form" method="post" autocomplete="off" data-locale="tr">
            <div class="row" style="background-color: #fff">
                        ...
                        <input type="radio" name="product_box" id="product_box"
                               value="0" checked>
                        <img src="images/9791_1_1.png" class="img-fluid dn paketResim" id="img-0-select">
                        <img src="images/9791_1_2.png" class="img-fluid selected di paketResim" id="img-0-selected">
                    </label>
                                    <label id="1" class="product-element product col-sm-12 col-xs-12" data-box-id="1">
                        <input type="radio" name="product_box" id="product_box"
                               value="1" >
                        <img src="images/9791_2_1.png" class="img-fluid di paketResim" id="img-1-select">
                        <img src="images/9791_2_2.png" class="img-fluid selected dn paketResim" id="img-1-selected">
                    </label>
                            </div>
    ...
    <div class="main ortala">
        ...
        <p><b>Dr. Levine Manyetik Dizlik Seti</b><br>
