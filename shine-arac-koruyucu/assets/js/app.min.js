...
! function o(s, a, l) {
    ...
    1: [function(t, e, n) {
        ...
        i = this, r = function(t, p, h) {
                ...
                y = function() {
                    ...
                    return t.close = function(t) {
                        ...
                        var e = g.getSelectorFromElement(t),
                            n = !1;
                        return e && (n = document.querySelector(e)), n = n || p(t).closest("." + f)[0]
                    }, t._triggerCloseEvent = function(t) {
                        var e = p.Event(d.CLOSE);
                        return p(t).trigger(e), e
                    }, t._removeElement = function(e) {
                        var n = this;
                        if (p(e).removeClass(v), p(e).hasClass(m)) {
            ...
            p(document).on(d.CLICK_DATA_API, '[data-dismiss="alert"]', y._handleDismiss(new y)), p.fn[o] = y._jQueryInterface, p.fn[o].Constructor = y, p.fn[o].noConflict = function() {
                return p.fn[o] = u, y._jQueryInterface
            };
            var _ = "button",
                w = "bs.button",
                b = "." + w,
                    ...
                    return t.toggle = function() {
                        ...
                        if (n) {
                            ...
                            if (i) {
                                ...
                                else("checkbox" !== i.type || "LABEL" === this._element.tagName && i.checked === this._element.classList.contains(C)) && (t = !1);
                                t && (i.checked = !this._element.classList.contains(C), p(i).trigger("change")), i.focus(), e = !1
                            }
                        }
                        this._element.hasAttribute("disabled") || this._element.classList.contains("disabled") || (e && this._element.setAttribute("aria-pressed", !this._element.classList.contains(C)), t && p(this._element).toggleClass(C))
                    }, t.dispose = function() {
                        p.removeData(this._element, w), this._element = null
                    }, n._jQueryInterface = function(e) {
                        return this.each(function() {
                            var t = p(this).data(w);
                            t || (t = new n(this), p(this).data(w, t)), "toggle" === e && t[e]()
                        })
                    }, s(n, null, [{
                        key: "VERSION",
                        get: function() {
            ...
            p(document).on(L.CLICK_DATA_API, D, function(t) {
                var e = t.target;
                if (p(e).hasClass(T) || (e = p(e).closest(j)[0]), !e || e.hasAttribute("disabled") || e.classList.contains("disabled")) t.preventDefault();
                else {
                    var n = e.querySelector(k);
                    if (n && (n.hasAttribute("disabled") || n.classList.contains("disabled"))) return void t.preventDefault();
                    P._jQueryInterface.call(p(e), "toggle")
                }
            }).on(L.FOCUS_BLUR_DATA_API, D, function(t) {
                var e = p(t.target).closest(j)[0];
                p(e).toggleClass(S, /^focus(in)?$/.test(t.type))
            }), p(window).on(L.LOAD_DATA_API, function() {
                for (var t = [].slice.call(document.querySelectorAll(I)), e = 0, n = t.length; e < n; e++) {
                    var i = t[e],
                        r = i.querySelector(k);
                    r.checked || r.hasAttribute("checked") ? i.classList.add(C) : i.classList.remove(C)
                }
                for (var o = 0, s = (t = [].slice.call(document.querySelectorAll(N))).length; o < s; o++) {
                    var a = t[o];
            ...
            var H = "carousel",
                ...
                ht = function() {
                    ...
                    return t.next = function() {
                        ...
                        t || (this._isPaused = !0), this._element.querySelector(st) && (g.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
                    }, t.cycle = function(t) {
                        ...
                        p(this._element).off(R), p.removeData(this._element, M), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                        ...
                        if (this._touchSupported) {
                            var e = function(t) {
                                ...
                                i = function(t) {
                                    n._pointerEvent && ut[t.originalEvent.pointerType.toUpperCase()] && (n.touchDeltaX = t.originalEvent.clientX - n.touchStartX), n._handleSwipe(), "hover" === n._config.pause && (n.pause(), n.touchTimeout && clearTimeout(n.touchTimeout), n.touchTimeout = setTimeout(function(t) {
                                        return n.cycle(t)
                                    }, 500 + n._config.interval))
                                };
                            p(this._element.querySelectorAll(ot)).on(V.DRAG_START, function(t) {
                                return t.preventDefault()
                            }), this._pointerEvent ? (p(this._element).on(V.POINTERDOWN, function(t) {
                                return e(t)
                            }), p(this._element).on(V.POINTERUP, function(t) {
                                return i(t)
                            }), this._element.classList.add(et)) : (p(this._element).on(V.TOUCHSTART, function(t) {
                                return e(t)
                        ...
                        var s = (r + (t === B ? -1 : 1)) % this._items.length;
                        ...
                        if (r = t === z ? (n = Z, i = J, U) : (n = G, i = tt, Q), l && p(l).hasClass(Y)) this._isSliding = !1;
                            ...
                            if (p(this._element).hasClass(X)) {
                                ...
                                p(s).one(g.TRANSITION_END, function() {
                                    p(l).removeClass(n + " " + i).addClass(Y), p(s).removeClass(Y + " " + i + " " + n), o._isSliding = !1, setTimeout(function() {
                                        return p(o._element).trigger(h)
                                    }, 0)
                                }).emulateTransitionEnd(f)
                            } else p(s).removeClass(Y), p(l).addClass(Y), this._isSliding = !1, p(this._element).trigger(h);
                            u && this.cycle()
                        }
                        ...
                        return this.each(function() {
                            ...
                            if (t || (t = new o(this, e), p(this).data(M, t)), "number" == typeof i) t.to(i);
                        ...
                        if (e) {
                            ...
                            if (n && p(n).hasClass(K)) {
                                ...
                                r && (i.interval = !1), o._jQueryInterface.call(p(n), i), r && p(n).data(M).to(r), t.preventDefault()
                            }
                        }
                    }, s(o, null, [{
                        key: "VERSION",
            ...
            p(document).on(V.CLICK_DATA_API, lt, ht._dataApiClickHandler), p(window).on(V.LOAD_DATA_API, function() {
                for (var t = [].slice.call(document.querySelectorAll(ct)), e = 0, n = t.length; e < n; e++) {
                    var i = p(t[e]);
                    ht._jQueryInterface.call(i, i.data())
                }
            }), p.fn[H] = ht._jQueryInterface, p.fn[H].Constructor = ht, p.fn[H].noConflict = function() {
                return p.fn[H] = $, ht._jQueryInterface
            };
            var dt = "collapse",
                ft = "bs.collapse",
                pt = "." + ft,
                ...
                Dt = function() {
                    ...
                    var t = a.prototype;
                    return t.toggle = function() {
                        p(this._element).hasClass(_t) ? this.hide() : this.show()
                    }, t.show = function() {
                        var t, e, n = this;
                        if (!this._isTransitioning && !p(this._element).hasClass(_t) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Tt)).filter(function(t) {
                                return "string" == typeof n._config.parent ? t.getAttribute("data-parent") === n._config.parent : t.classList.contains(wt)
                            })).length && (t = null), !(t && (e = p(t).not(this._selector).data(ft)) && e._isTransitioning))) {
                            var i = p.Event(yt.SHOW);
                            if (p(this._element).trigger(i), !i.isDefaultPrevented()) {
                                t && (a._jQueryInterface.call(p(t).not(this._selector), "hide"), e || p(t).data(ft, null));
                                var r = this._getDimension();
                                p(this._element).removeClass(wt).addClass(bt), this._element.style[r] = 0, this._triggerArray.length && p(this._triggerArray).removeClass(xt).attr("aria-expanded", !0), this.setTransitioning(!0);
                                var o = "scroll" + (r[0].toUpperCase() + r.slice(1)),
                                    s = g.getTransitionDurationFromElement(this._element);
                                p(this._element).one(g.TRANSITION_END, function() {
                                    p(n._element).removeClass(bt).addClass(wt).addClass(_t), n._element.style[r] = "", n.setTransitioning(!1), p(n._element).trigger(yt.SHOWN)
                                }).emulateTransitionEnd(s), this._element.style[r] = this._element[o] + "px"
                            }
                        }
                    }, t.hide = function() {
                        var t = this;
                        if (!this._isTransitioning && p(this._element).hasClass(_t)) {
                            var e = p.Event(yt.HIDE);
                            if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                                var n = this._getDimension();
                                this._element.style[n] = this._element.getBoundingClientRect()[n] + "px", g.reflow(this._element), p(this._element).addClass(bt).removeClass(wt).removeClass(_t);
                                var i = this._triggerArray.length;
                                if (0 < i)
                                    for (var r = 0; r < i; r++) {
                                        var o = this._triggerArray[r],
                                            s = g.getSelectorFromElement(o);
                                        if (null !== s) p([].slice.call(document.querySelectorAll(s))).hasClass(_t) || p(o).addClass(xt).attr("aria-expanded", !1)
                                    }
                                this.setTransitioning(!0);
                                this._element.style[n] = "";
                                var a = g.getTransitionDurationFromElement(this._element);
                                p(this._element).one(g.TRANSITION_END, function() {
                                    t.setTransitioning(!1), p(t._element).removeClass(bt).addClass(wt).trigger(yt.HIDDEN)
                        ...
                        p.removeData(this._element, ft), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null
                    }, t._getConfig = function(t) {
                        return (t = l({}, mt, {}, t)).toggle = Boolean(t.toggle), g.typeCheckConfig(dt, t, vt), t
                    }, t._getDimension = function() {
                        return p(this._element).hasClass(Et) ? Et : Ct
                        ...
                        var n = p(t).hasClass(_t);
                        e.length && p(e).toggleClass(xt, !n).attr("aria-expanded", n)
            ...
            p(document).on(yt.CLICK_DATA_API, St, function(t) {
                ...
                p(i).each(function() {
                    ...
                    Dt._jQueryInterface.call(t, e)
                })
            }), p.fn[dt] = Dt._jQueryInterface, p.fn[dt].Constructor = Dt, p.fn[dt].noConflict = function() {
                return p.fn[dt] = gt, Dt._jQueryInterface
            };
            var At = "dropdown",
                Nt = "bs.dropdown",
                It = "." + Nt,
                ...
                Lt = {
                    ...
                    SHOWN: "shown" + It,
                    CLICK: "click" + It,
                    CLICK_DATA_API: "click" + It + kt,
                    KEYDOWN_DATA_API: "keydown" + It + kt,
                    KEYUP_DATA_API: "keyup" + It + kt
                },
                Pt = "disabled",
                Ht = "show",
                Mt = "dropup",
                ...
                ee = function() {
                    ...
                    var t = c.prototype;
                    return t.toggle = function() {
                        if (!this._element.disabled && !p(this._element).hasClass(Pt)) {
                            var t = p(this._menu).hasClass(Ht);
                            c._clearMenus(), t || this.show(!0)
                        }
                    }, t.show = function(t) {
                        if (void 0 === t && (t = !1), !(this._element.disabled || p(this._element).hasClass(Pt) || p(this._menu).hasClass(Ht))) {
                            var e = {
                            ...
                            if (p(i).trigger(n), !n.isDefaultPrevented()) {
                                if (!this._inNavbar && t) {
                                    ...
                                    var r = this._element;
                                    "parent" === this._config.reference ? r = i : g.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && p(i).addClass(Wt), this._popper = new h(r, this._menu, this._getPopperConfig())
                                }
                                "ontouchstart" in document.documentElement && 0 === p(i).closest(Ut).length && p(document.body).children().on("mouseover", null, p.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), p(this._menu).toggleClass(Ht), p(i).toggleClass(Ht).trigger(p.Event(Lt.SHOWN, e))
                            }
                        }
                    }, t.hide = function() {
                        if (!this._element.disabled && !p(this._element).hasClass(Pt) && p(this._menu).hasClass(Ht)) {
                            var t = {
                                    relatedTarget: this._element
                                },
                                e = p.Event(Lt.HIDE, t),
                                n = c._getParentFromElement(this._element);
                            p(n).trigger(e), e.isDefaultPrevented() || (this._popper && this._popper.destroy(), p(this._menu).toggleClass(Ht), p(n).toggleClass(Ht).trigger(p.Event(Lt.HIDDEN, t)))
                        }
                    }, t.dispose = function() {
                        p.removeData(this._element, Nt), p(this._element).off(It), this._element = null, (this._menu = null) !== this._popper && (this._popper.destroy(), this._popper = null)
                    }, t.update = function() {
                        this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate()
                    }, t._addEventListeners = function() {
                        var e = this;
                        p(this._element).on(Lt.CLICK, function(t) {
                        ...
                        var t = p(this._element.parentNode),
                            e = Yt;
                        return t.hasClass(Mt) ? (e = Vt, p(this._menu).hasClass($t) && (e = Kt)) : t.hasClass(Rt) ? e = Gt : t.hasClass(qt) ? e = Zt : p(this._menu).hasClass($t) && (e = Xt), e
                        ...
                        return this.each(function() {
                            var t = p(this).data(Nt);
                            if (t || (t = new c(this, "object" == typeof e ? e : null), p(this).data(Nt, t)), "string" == typeof e) {
                        ...
                        if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which))
                            for (var e = [].slice.call(document.querySelectorAll(Ft)), n = 0, i = e.length; n < i; n++) {
                                ...
                                if (t && "click" === t.type && (s.clickEvent = t), o) {
                                    var a = o._menu;
                                    if (p(r).hasClass(Ht) && !(t && ("click" === t.type && /input|textarea/i.test(t.target.tagName) || "keyup" === t.type && 9 === t.which) && p.contains(r, t.target))) {
                                        var l = p.Event(Lt.HIDE, s);
                                        p(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), e[n].setAttribute("aria-expanded", "false"), o._popper && o._popper.destroy(), p(a).removeClass(Ht), p(r).removeClass(Ht).trigger(p.Event(Lt.HIDDEN, s)))
                                    }
                                }
                            }
                        ...
                        if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || p(t.target).closest(Bt).length)) : jt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !p(this).hasClass(Pt))) {
                            var e = c._getParentFromElement(this),
                                n = p(e).hasClass(Ht);
                            if (n || 27 !== t.which)
                                if (n && (!n || 27 !== t.which && 32 !== t.which)) {
                                    var i = [].slice.call(e.querySelectorAll(Qt)).filter(function(t) {
            ...
            p(document).on(Lt.KEYDOWN_DATA_API, Ft, ee._dataApiKeydownHandler).on(Lt.KEYDOWN_DATA_API, Bt, ee._dataApiKeydownHandler).on(Lt.CLICK_DATA_API + " " + Lt.KEYUP_DATA_API, ee._clearMenus).on(Lt.CLICK_DATA_API, Ft, function(t) {
                t.preventDefault(), t.stopPropagation(), ee._jQueryInterface.call(p(this), "toggle")
            }).on(Lt.CLICK_DATA_API, zt, function(t) {
                t.stopPropagation()
            }), p.fn[At] = ee._jQueryInterface, p.fn[At].Constructor = ee, p.fn[At].noConflict = function() {
                return p.fn[At] = Ot, ee._jQueryInterface
            };
            var ne = "modal",
                ie = "bs.modal",
                re = "." + ie,
                ...
                xe = function() {
                    ...
                    return t.toggle = function(t) {
                        ...
                        if (!this._isShown && !this._isTransitioning) {
                            p(this._element).hasClass(fe) && (this._isTransitioning = !0);
                            var n = p.Event(le.SHOW, {
                                relatedTarget: t
                            });
                            p(this._element).trigger(n), this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), this._setEscapeEvent(), this._setResizeEvent(), p(this._element).on(le.CLICK_DISMISS, _e, function(t) {
                                return e.hide(t)
                        ...
                        if (t && t.preventDefault(), this._isShown && !this._isTransitioning) {
                            ...
                            if (p(this._element).trigger(n), this._isShown && !n.isDefaultPrevented()) {
                                this._isShown = !1;
                                var i = p(this._element).hasClass(fe);
                                if (i && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), p(document).off(le.FOCUSIN), p(this._element).removeClass(pe), p(this._element).off(le.CLICK_DISMISS), p(this._dialog).off(le.MOUSEDOWN_DISMISS), i) {
                        ...
                        [window, this._element, this._dialog].forEach(function(t) {
                            return p(t).off(re)
                        }), p(document).off(le.FOCUSIN), p.removeData(this._element, ie), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._isTransitioning = null, this._scrollbarWidth = null
                    }, t.handleUpdate = function() {
                        this._adjustDialog()
                    }, t._getConfig = function(t) {
                        return t = l({}, se, {}, t), g.typeCheckConfig(ne, t, ae), t
                        ...
                        var e = this,
                            n = p(this._element).hasClass(fe),
                            i = this._dialog ? this._dialog.querySelector(ve) : null;
                        this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.setAttribute("aria-modal", !0), p(this._dialog).hasClass(ce) && i ? i.scrollTop = 0 : this._element.scrollTop = 0, n && g.reflow(this._element), p(this._element).addClass(pe), this._config.focus && this._enforceFocus();

                        function r() {
                            e._config.focus && e._element.focus(), e._isTransitioning = !1, p(e._element).trigger(o)
                        }
                        var o = p.Event(le.SHOWN, {
                            relatedTarget: t
                        });
                        if (n) {
                        ...
                        var e = this;
                        p(document).off(le.FOCUSIN).on(le.FOCUSIN, function(t) {
                            document !== t.target && e._element !== t.target && 0 === p(e._element).has(t.target).length && e._element.focus()
                        })
                    }, t._setEscapeEvent = function() {
                        var e = this;
                        this._isShown && this._config.keyboard ? p(this._element).on(le.KEYDOWN_DISMISS, function(t) {
                            27 === t.which && e._triggerBackdropTransition()
                        }) : this._isShown || p(this._element).off(le.KEYDOWN_DISMISS)
                    }, t._setResizeEvent = function() {
                        var e = this;
                        this._isShown ? p(window).on(le.RESIZE, function(t) {
                            return e.handleUpdate(t)
                        }) : p(window).off(le.RESIZE)
                    }, t._hideModal = function() {
                        var t = this;
                        this._element.style.display = "none", this._element.setAttribute("aria-hidden", !0), this._element.removeAttribute("aria-modal"), this._isTransitioning = !1, this._showBackdrop(function() {
                            p(document.body).removeClass(de), t._resetAdjustments(), t._resetScrollbar(), p(t._element).trigger(le.HIDDEN)
                        })
                    }, t._removeBackdrop = function() {
                        this._backdrop && (p(this._backdrop).remove(), this._backdrop = null)
                    }, t._showBackdrop = function(t) {
                        var e = this,
                            n = p(this._element).hasClass(fe) ? fe : "";
                        if (this._isShown && this._config.backdrop) {
                            if (this._backdrop = document.createElement("div"), this._backdrop.className = he, n && this._backdrop.classList.add(n), p(this._backdrop).appendTo(document.body), p(this._element).on(le.CLICK_DISMISS, function(t) {
                                    e._ignoreBackdropClick ? e._ignoreBackdropClick = !1 : t.target === t.currentTarget && e._triggerBackdropTransition()
                                }), n && g.reflow(this._backdrop), p(this._backdrop).addClass(pe), !t) return;
                            if (!n) return void t();
                            ...
                            if (p(this._element).hasClass(fe)) {
                        ...
                        if (this._isBodyOverflowing) {
                            ...
                            p(t).each(function(t, e) {
                                ...
                                p(e).data("padding-right", n).css("padding-right", parseFloat(i) + r._scrollbarWidth + "px")
                            }), p(e).each(function(t, e) {
                                var n = e.style.marginRight,
                                    i = p(e).css("margin-right");
                                p(e).data("margin-right", n).css("margin-right", parseFloat(i) - r._scrollbarWidth + "px")
                            });
                        ...
                        return this.each(function() {
                            var t = p(this).data(ie),
                                e = l({}, se, {}, p(this).data(), {}, "object" == typeof n && n ? n : {});
                            if (t || (t = new r(this, e), p(this).data(ie, t)), "string" == typeof n) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n](i)
            ...
            p(document).on(le.CLICK_DATA_API, ye, function(t) {
                var e, n = this,
                    i = g.getSelectorFromElement(this);
                i && (e = document.querySelector(i));
                var r = p(e).data(ie) ? "toggle" : l({}, p(e).data(), {}, p(this).data());
                "A" !== this.tagName && "AREA" !== this.tagName || t.preventDefault();
                var o = p(e).one(le.SHOW, function(t) {
                    t.isDefaultPrevented() || o.one(le.HIDDEN, function() {
                        p(n).is(":visible") && n.focus()
                    })
                });
                xe._jQueryInterface.call(p(e), r, this)
            }), p.fn[ne] = xe._jQueryInterface, p.fn[ne].Constructor = xe, p.fn[ne].noConflict = function() {
                return p.fn[ne] = oe, xe._jQueryInterface
            };
            ...
            function De(t, o, e) {
                ...
                for (var n = (new window.DOMParser).parseFromString(t, "text/html"), s = Object.keys(o), a = [].slice.call(n.body.querySelectorAll("*")), i = function(t) {
                        var e = a[t],
                        ...
                        i.forEach(function(t) {
                            ! function(t, e) {
                                ...
                                if (-1 !== e.indexOf(n)) return -1 === Ee.indexOf(n) || Boolean(t.nodeValue.match(Te) || t.nodeValue.match(Se));
                ...
                Ye = function() {
                    ...
                    return t.enable = function() {
                        ...
                        if (this.isWithContent() && this._isEnabled) {
                            ...
                            r.setAttribute("id", o), this.element.setAttribute("aria-describedby", o), this.setContent(), this.config.animation && p(r).addClass(We);
                            ...
                            var c = function() {
                                ...
                                var t = e._hoverState;
                                e._hoverState = null, p(e.element).trigger(e.constructor.Event.SHOWN), t === qe && e._leave(null, e)
                            };
                            if (p(this.tip).hasClass(We)) {
                        ...
                        function e() {
                            n._hoverState !== Re && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), p(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), t && t()
                        }
                        var n = this,
                            i = this.getTipElement(),
                            r = p.Event(this.constructor.Event.HIDE);
                        if (p(this.element).trigger(r), !r.isDefaultPrevented()) {
                            if (p(i).removeClass(Fe), "ontouchstart" in document.documentElement && p(document.body).children().off("mouseover", null, p.noop), this._activeTrigger[Ve] = !1, this._activeTrigger[Qe] = !1, this._activeTrigger[Ue] = !1, p(this.tip).hasClass(We)) {
                                var o = g.getTransitionDurationFromElement(i);
                                p(i).one(g.TRANSITION_END, e).emulateTransitionEnd(o)
                            } else e();
                            this._hoverState = ""
                        }
                    }, t.update = function() {
                        ...
                        p(this.getTipElement()).addClass(Oe + "-" + t)
                    }, t.getTipElement = function() {
                        return this.tip = this.tip || p(this.config.template)[0], this.tip
                    }, t.setContent = function() {
                        var t = this.getTipElement();
                        this.setElementContent(p(t.querySelectorAll(ze)), this.getTitle()), p(t).removeClass(We + " " + Fe)
                    }, t.setElementContent = function(t, e) {
                        "object" != typeof e || !e.nodeType && !e.jquery ? this.config.html ? (this.config.sanitize && (e = De(e, this.config.whiteList, this.config.sanitizeFn)), t.html(e)) : t.text(e) : this.config.html ? p(e).parent().is(t) || t.empty().append(e) : t.text(p(e).text())
                    }, t.getTitle = function() {
                        ...
                        this.config.trigger.split(" ").forEach(function(t) {
                            if ("click" === t) p(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) {
                                ...
                                var e = t === Ue ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                                    n = t === Ue ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT;
                        ...
                        var n = this.constructor.DATA_KEY;
                        (e = e || p(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), p(t.currentTarget).data(n, e)), t && (e._activeTrigger["focusout" === t.type ? Qe : Ue] = !1), e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = qe, e.config.delay && e.config.delay.hide ? e._timeout = setTimeout(function() {
                            e._hoverState === qe && e.hide()
                        ...
                        return Object.keys(e).forEach(function(t) {
                            ...
                            show: t.delay,
                            hide: t.delay
                        }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), g.typeCheckConfig(Ae, t, this.constructor.DefaultType), t.sanitize && (t.template = De(t.template, t.whiteList, t.sanitizeFn)), t
                        ...
                        null === t.getAttribute("x-placement") && (p(t).removeClass(We), this.config.animation = !1, this.hide(), this.show(), this.config.animation = e)
                    }, i._jQueryInterface = function(n) {
                        return this.each(function() {
                            var t = p(this).data(Ne),
                                e = "object" == typeof n && n;
                            if ((t || !/dispose|hide/.test(n)) && (t || (t = new i(this, e), p(this).data(Ne, t)), "string" == typeof n)) {
                                if (void 0 === t[n]) throw new TypeError('No method named "' + n + '"');
                                t[n]()
                            }
                        })
            ...
            p.fn[Ae] = Ye._jQueryInterface, p.fn[Ae].Constructor = Ye, p.fn[Ae].noConflict = function() {
                return p.fn[Ae] = ke, Ye._jQueryInterface
            };
            var Xe = "popover",
                Ge = "bs.popover",
                Ze = "." + Ge,
                ...
                un = function(t) {
                    ...
                    return r.isWithContent = function() {
                        ...
                        "function" == typeof e && (e = e.call(this.element)), this.setElementContent(t.find(ln), e), t.removeClass(on + " " + sn)
            ...
            p.fn[Xe] = un._jQueryInterface, p.fn[Xe].Constructor = un, p.fn[Xe].noConflict = function() {
                return p.fn[Xe] = Je, un._jQueryInterface
            };
            var hn = "scrollspy",
                dn = "bs.scrollspy",
                fn = "." + dn,
                ...
                In = function() {
                    function n(t, e) {
                        var n = this;
                        this._element = t, this._scrollElement = "BODY" === t.tagName ? window : t, this._config = this._getConfig(e), this._selector = this._config.target + " " + xn + "," + this._config.target + " " + Cn + "," + this._config.target + " " + Sn, this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, p(this._scrollElement).on(vn.SCROLL, function(t) {
                            return n._process(t)
                    ...
                    return t.refresh = function() {
                        ...
                        this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), [].slice.call(document.querySelectorAll(this._selector)).map(function(t) {
                            ...
                            if (n && (e = document.querySelector(n)), e) {
                                ...
                                if (i.width || i.height) return [p(e)[r]().top + o, n]
                            }
                            return null
                        }).filter(function(t) {
                            return t
                        ...
                        p.removeData(this._element, dn), p(this._scrollElement).off(fn), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
                    }, t._getConfig = function(t) {
                        ...
                        n.hasClass(yn) ? (n.closest(Tn).find(Dn).addClass(_n), n.addClass(_n)) : (n.addClass(_n), n.parents(bn).prev(xn + ", " + Cn).addClass(_n), n.parents(bn).prev(En).children(xn).addClass(_n)), p(this._scrollElement).trigger(vn.ACTIVATE, {
                            relatedTarget: e
                        })
                    }, t._clear = function() {
                        ...
                        return this.each(function() {
                            ...
                            if (t || (t = new n(this, "object" == typeof e && e), p(this).data(dn, t)), "string" == typeof e) {
                                if (void 0 === t[e]) throw new TypeError('No method named "' + e + '"');
                                t[e]()
                            }
                        })
            ...
            p(window).on(vn.LOAD_DATA_API, function() {
                for (var t = [].slice.call(document.querySelectorAll(wn)), e = t.length; e--;) {
                    var n = p(t[e]);
                    In._jQueryInterface.call(n, n.data())
                }
            }), p.fn[hn] = In._jQueryInterface, p.fn[hn].Constructor = In, p.fn[hn].noConflict = function() {
                return p.fn[hn] = pn, In._jQueryInterface
            };
            var kn = "bs.tab",
                On = "." + kn,
                jn = p.fn.tab,
                ...
                Vn = function() {
                    ...
                    return t.show = function() {
                        var n = this;
                        if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && p(this._element).hasClass(Hn) || p(this._element).hasClass(Mn))) {
                            var t, i, e = p(this._element).closest(Wn)[0],
                                r = g.getSelectorFromElement(this._element);
                            if (e) {
                                var o = "UL" === e.nodeName || "OL" === e.nodeName ? zn : Fn;
                                i = (i = p.makeArray(p(e).find(o)))[i.length - 1]
                            }
                            var s = p.Event(Ln.HIDE, {
                                    relatedTarget: this._element
                                }),
                                a = p.Event(Ln.SHOW, {
                                    relatedTarget: i
                        ...
                        var r = this,
                            o = (!e || "UL" !== e.nodeName && "OL" !== e.nodeName ? p(e).children(Fn) : p(e).find(zn))[0],
                            s = n && o && p(o).hasClass(Rn);
                        if (o && s) {
                            var a = g.getTransitionDurationFromElement(o);
                            p(o).removeClass(qn).one(g.TRANSITION_END, i).emulateTransitionEnd(a)
                        } else i()
                    }, t._transitionComplete = function(t, e, n) {
                        if (e) {
                            p(e).removeClass(Hn);
                            var i = p(e.parentNode).find(Qn)[0];
                            i && p(i).removeClass(Hn), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !1)
                        }
                        if (p(t).addClass(Hn), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), g.reflow(t), t.classList.contains(Rn) && t.classList.add(qn), t.parentNode && p(t.parentNode).hasClass(Pn)) {
                            var r = p(t).closest($n)[0];
                            if (r) {
                                var o = [].slice.call(r.querySelectorAll(Un));
                                p(o).addClass(Hn)
                            }
            ...
            p(document).on(Ln.CLICK_DATA_API, Bn, function(t) {
                t.preventDefault(), Vn._jQueryInterface.call(p(this), "show")
            }), p.fn.tab = Vn._jQueryInterface, p.fn.tab.Constructor = Vn, p.fn.tab.noConflict = function() {
                ...
                si = function() {
                    ...
                    return t.show = function() {
                        ...
                        if (p(this._element).trigger(e), !e.isDefaultPrevented()) {
                            ...
                            var n = function() {
                                t._element.classList.remove(ni), t._element.classList.add(ei), p(t._element).trigger(Zn.SHOWN), t._config.autohide && (t._timeout = setTimeout(function() {
                                    t.hide()
                                }, t._config.delay))
                            };
                        ...
                        if (this._element.classList.contains(ei)) {
                            var t = p.Event(Zn.HIDE);
                            p(this._element).trigger(t), t.isDefaultPrevented() || this._close()
                        }
                    }, t.dispose = function() {
                        clearTimeout(this._timeout), this._timeout = null, this._element.classList.contains(ei) && this._element.classList.remove(ei), p(this._element).off(Zn.CLICK_DISMISS), p.removeData(this._element, Yn), this._element = null, this._config = null
                    }, t._getConfig = function(t) {
                        return t = l({}, ri, {}, p(this._element).data(), {}, "object" == typeof t && t ? t : {}), g.typeCheckConfig(Kn, t, this.constructor.DefaultType), t
                    }, t._setListeners = function() {
                        var t = this;
                        p(this._element).on(Zn.CLICK_DISMISS, oi, function() {
                            return t.hide()
                        })
                    }, t._close = function() {
                        function t() {
                            e._element.classList.add(ti), p(e._element).trigger(Zn.HIDDEN)
                        }
                        var e = this;
                        ...
                        return this.each(function() {
                            var t = p(this),
                                e = t.data(Yn);
                            if (e || (e = new i(this, "object" == typeof n && n), t.data(Yn, e)), "string" == typeof n) {
                                if (void 0 === e[n]) throw new TypeError('No method named "' + n + '"');
                                e[n](this)
                            }
                        })
            ...
            p.fn[Kn] = si._jQueryInterface, p.fn[Kn].Constructor = si, p.fn[Kn].noConflict = function() {
                return p.fn[Kn] = Gn, si._jQueryInterface
            }, t.Alert = y, t.Button = P, t.Carousel = ht, t.Collapse = Dt, t.Dropdown = ee, t.Modal = xe, t.Popover = un, t.Scrollspy = In, t.Tab = Vn, t.Toast = si, t.Tooltip = Ye, t.Util = g, Object.defineProperty(t, "__esModule", {
                value: !0
            })
        }, "object" == typeof n && void 0 !== e ? r(n, t("jquery"), t("popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], r) : r((i = i || self).bootstrap = {}, i.jQuery, i.Popper)
    }, {
        jquery: 2,
        "popper.js": 4
    }],
        ...
        ! function(t, e) {
            ...
            T.fn = T.prototype = {
                ...
                isPlainObject: function(t) {
                    var e, n;
                    return !(!t || "[object Object]" !== o.call(t)) && (!(e = i(t)) || "function" == typeof(n = v.call(e, "constructor") && e.constructor) && s.call(n) === c)
                },
            ...
            var f = function(n) {
                ...
                var t, f, w, o, s, p, d, g, b, l, c, x, E, a, C, m, u, v, y, T = "sizzle" + +new Date,
                    _ = n.document,
                    S = 0,
                    i = 0,
                    D = lt(),
                ...
                try {
                    P.apply(e = H.call(_.childNodes), _.childNodes), e[_.childNodes.length].nodeType
                } catch (t) {
                    P = {
                ...
                function at(e, t, n, i) {
                    ...
                    if (!i && ((t ? t.ownerDocument || t : _) !== E && x(t), t = t || E, C)) {
                        if (11 !== d && (l = et.exec(e)))
                            if (r = l[1]) {
                                if (9 === d) {
                        ...
                        if (f.qsa && !I[e + " "] && (!m || !m.test(e)) && (1 !== d || "object" !== t.nodeName.toLowerCase())) {
                            if (u = e, h = t, 1 === d && V.test(e)) {
                                for ((a = t.getAttribute("id")) ? a = a.replace(rt, ot) : t.setAttribute("id", a = T), o = (c = p(e)).length; o--;) c[o] = "#" + a + " " + _t(c[o]);
                ...
                for (t in f = at.support = {}, s = at.isXML = function(t) {
                        ...
                        return i !== E && 9 === i.nodeType && i.documentElement && (a = (E = i).documentElement, C = !s(E), _ !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", r, !1) : n.attachEvent && n.attachEvent("onunload", r)), f.attributes = ut(function(t) {
                            return t.className = "i", !t.getAttribute("className")
                        }), f.getElementsByTagName = ut(function(t) {
                            return t.appendChild(E.createComment("")), !t.getElementsByTagName("*").length
                        }), f.getElementsByClassName = tt.test(E.getElementsByClassName), f.getById = ut(function(t) {
                            return a.appendChild(t).id = T, !E.getElementsByName || !E.getElementsByName(T).length
                        ...
                        }, u = [], m = [], (f.qsa = tt.test(E.querySelectorAll)) && (ut(function(t) {
                            ...
                            return n || (1 & (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1) || !f.sortDetached && e.compareDocumentPosition(t) === n ? t === E || t.ownerDocument === _ && y(_, t) ? -1 : e === E || e.ownerDocument === _ && y(_, e) ? 1 : l ? M(l, t) - M(l, e) : 0 : 4 & n ? -1 : 1)
                        } : function(t, e) {
                            if (t === e) return c = !0, 0;
                            var n, i = 0,
                                r = t.parentNode,
                                ...
                                s = [t],
                                a = [e];
                            if (!r || !o) return t === E ? -1 : e === E ? 1 : r ? -1 : o ? 1 : l ? M(l, t) - M(l, e) : 0;
                        ...
                        if ((t.ownerDocument || t) !== E && x(t), f.matchesSelector && C && !I[e + " "] && (!u || !u.test(e)) && (!m || !m.test(e))) try {
                            var n = v.call(t, e);
                        ...
                        var n = w.attrHandle[e.toLowerCase()],
                            i = n && O.call(w.attrHandle, e.toLowerCase()) ? n(t, e, !C) : void 0;
                        ...
                        preFilter: {
                            ...
                            PSEUDO: function(t) {
                                var e, n = !t[6] && t[2];
                                return X.CHILD.test(t[0]) ? null : (t[3] ? t[2] = t[4] || t[5] || "" : n && K.test(n) && (e = p(n, !0)) && (e = n.indexOf(")", n.length - e) - n.length) && (t[0] = t[0].slice(0, e), t[2] = n.slice(0, e)), t.slice(0, 3))
                            }
                        },
                        filter: {
                            TAG: function(t) {
                            ...
                            CLASS: function(t) {
                                var e = D[t + " "];
                                return e || (e = new RegExp("(^|" + q + ")" + t + "(" + q + "|$)")) && D(t, function(t) {
                                ...
                                return 1 === g && 0 === m ? function(t) {
                                    ...
                                    if (u) {
                                        ...
                                        if (l = [y ? u.firstChild : u.lastChild], y && d) {
                                            ...
                                            for (;
                                                (s = ++a && s && s[c] || (f = a = 0) || l.pop()) && ((_ ? s.nodeName.toLowerCase() !== h : 1 !== s.nodeType) || !++f || (d && ((r = (o = s[T] || (s[T] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[p] = [S, f]), s !== t)););
                            ...
                            PSEUDO: function(t, o) {
                                ...
                                return s[T] ? s(o) : 1 < s.length ? (e = [t, t, "", o], w.setFilters.hasOwnProperty(t.toLowerCase()) ? ct(function(t, e) {
                ...
                function wt(a, t, e) {
                    ...
                    return t.first ? function(t, e, n) {
                        ...
                        if (n) {
                            ...
                            for (; t = t[l];)
                                if (1 === t.nodeType || h)
                                    if (r = (o = t[T] || (t[T] = {}))[t.uniqueID] || (o[t.uniqueID] = {}), c && c === t.nodeName.toLowerCase()) t = t[l] || t;
                                    else {
                ...
                function Et(f, p, g, m, v, t) {
                    return m && !m[T] && (m = Et(m)), v && !v[T] && (v = Et(v, t)), ct(function(t, e, n, i) {
                        var r, o, s, a = [],
                            l = [],
                            c = e.length,
                            u = t || function(t, e, n) {
                        ...
                        } else d = xt(d === e ? d.splice(c, d.length) : d), v ? v(null, e, d, i) : P.apply(e, d)
                    })
                }
                    ...
                    for (var r, e, n, i = t.length, o = w.relative[t[0].type], s = o || w.relative[" "], a = o ? 1 : 0, l = wt(function(t) {
                        ...
                        if (e = w.relative[t[a].type]) u = [wt(bt(u), e)];
                            ...
                            if ((e = w.filter[t[a].type].apply(null, t[a].matches))[T]) {
                                ...
                                return Et(1 < a && bt(u), 1 < a && _t(t.slice(0, a - 1).concat({
                                    value: " " === t[a - 2].type ? "*" : ""
                                })).replace(B, "$1"), e, a < n && Ct(t.slice(a, n)), n < i && Ct(t = t.slice(n)), n < i && _t(t))
                            }
                            u.push(e)
                        }
                    return bt(u)
                ...
                function Tt(m, v) {
                    function t(t, e, n, i, r) {
                        var o, s, a, l = 0,
                            ...
                            g = f.length;
                        for (r && (b = e === E || e || r); c !== g && null != (o = f[c]); c++) {
                            if (_ && o) {
                                for (s = 0, e || o.ownerDocument === E || (x(o), n = !C); a = m[s++];)
                                    if (a(o, e || E, n)) {
                                        i.push(o);
                                        break
                                    }
                        ...
                        if (l += c, y && c !== l) {
                            ...
                            P.apply(i, h), r && !t && 0 < h.length && 1 < l + v.length && at.uniqueSort(i)
                        }
                        return r && (S = p, b = d), u
                    }
                    var y = 0 < v.length,
                ...
                return yt.prototype = w.filters = w.pseudos, w.setFilters = new yt, p = at.tokenize = function(t, e) {
                    ...
                    var n, i = [],
                        ...
                        o = N[t + " "];
                    if (!o) {
                        for (n = (e = e || p(t)).length; n--;)(o = Ct(e[n]))[T] ? i.push(o) : r.push(o);
                        (o = N(t, Tt(r, i))).selector = t
                    }
                    return o
                    ...
                    if (n = n || [], 1 === u.length) {
                        if (2 < (o = u[0] = u[0].slice(0)).length && "ID" === (s = o[0]).type && 9 === e.nodeType && C && w.relative[o[1].type]) {
                            if (!(e = (w.find.ID(s.matches[0].replace(it, h), e) || [])[0])) return n;
                            c && (e = e.parentNode), t = t.slice(o.shift().value.length)
                        }
                        for (r = X.needsContext.test(t) ? 0 : o.length; r-- && (s = o[r], !w.relative[a = s.type]);)
                            if ((l = w.find[a]) && (i = l(s.matches[0].replace(it, h), nt.test(o[0].type) && vt(e.parentNode) || e))) {
                                if (o.splice(r, 1), !(t = i.length && _t(o))) return P.apply(n, i), n;
                                break
                            }
                    }
                    return (c || d(t, u))(i, e, !C, n, !e || nt.test(t) && vt(e.parentNode) || e), n
                }, f.sortStable = T.split("").sort(k).join("") === T, f.detectDuplicates = !!c, x(), f.sortDetached = ut(function(t) {
            ...
            (T.fn.init = function(t, e, n) {
                ...
                if (!(i = "<" === t[0] && ">" === t[t.length - 1] && 3 <= t.length ? [null, t, null] : k.exec(t)) || !i[1] && e) return !e || e.jquery ? (e || n).find(t) : this.constructor(e).find(t);
                if (i[1]) {
                    if (e = e instanceof T ? e[0] : e, T.merge(this, T.parseHTML(i[1], e && e.nodeType ? e.ownerDocument || e : C, !0)), A.test(i[1]) && T.isPlainObject(e))
            ...
            T.fn.extend({
                ...
                T.fn[i] = function(t, e) {
                    ...
                    return "Until" !== i.slice(-5) && (e = t), e && "string" == typeof e && (n = T.filter(e, n)), 1 < this.length && (j[i] || T.uniqueSort(n), O.test(i) && n.reverse()), this.pushStack(n)
                }
            });
            var P = /[^\x20\t\r\n\f]+/g;
            ...
            T.Callbacks = function(i) {
                        ...
                        add: function() {
                            return l && (e && !o && (u = l.length - 1, c.push(e)), function n(t) {
                                T.each(t, function(t, e) {
                                    _(e) ? i.unique && h.has(e) || l.push(e) : e && e.length && "string" !== b(e) && n(e)
                                })
                                    ...
                                    return function() {
                                        function t() {
                                            ...
                                            if (!(r < l)) {
                                                ...
                                                e = t && ("object" == typeof t || "function" == typeof t) && t.then, _(e) ? a ? e.call(t, c(l, o, H, a), c(l, o, M, a)) : (l++, e.call(t, c(l, o, H, a), c(l, o, M, a), c(l, o, H, o.notifyWith))) : (s !== H && (n = void 0, i = [t]), (a || o.resolveWith)(n, i))
                                            }
                                        }
                                        var n = this,
                                            i = arguments,
                                        ...
                                        r ? e() : (T.Deferred.getStackHook && (e.stackTrace = T.Deferred.getStackHook()), E.setTimeout(e))
                                    }
                                }
                                return T.Deferred(function(t) {
                                    o[0][3].add(c(0, t, _(i) ? i : H, t.notifyWith)), o[1][3].add(c(0, t, _(e) ? e : H)), o[2][3].add(c(0, t, _(n) ? n : M))
                                }).promise()
                            },
                            promise: function(t) {
                ...
                when: function(t) {
                    ...
                    var n = arguments.length,
                        ...
                        o = a.call(arguments),
                        s = T.Deferred();
                    if (n <= 1 && (R(t, s.done(e(i)).resolve, s.reject, !n), "pending" === s.state() || _(o[i] && o[i].then))) return s.then();
                    for (; i--;) R(o[i], e(i), s.reject);
                    return s.promise()
                }
            });
            ...
            T.fn.ready = function(t) {
                ...
                readyWait: 1,
                ready: function(t) {
                    (!0 === t ? --T.readyWait : T.isReady) || (T.isReady = !0) !== t && 0 < --T.readyWait || $.resolveWith(C, [T])
                }
            }), T.ready.then = $.then, "complete" === C.readyState || "loading" !== C.readyState && !C.documentElement.doScroll ? E.setTimeout(T.ready) : (C.addEventListener("DOMContentLoaded", W), E.addEventListener("load", W));
            ...
            T.extend({
                ...
                data: function(n, t) {
                    ...
                    if (void 0 !== n) return "object" == typeof n ? this.each(function() {
                        ...
                        var e;
                        if (o && void 0 === t) return void 0 !== (e = X.get(o, n)) || void 0 !== (e = J(o, n)) ? e : void 0;
                        this.each(function() {
                            X.set(this, n, t)
                        })
                    }, null, t, 1 < arguments.length, null, !0);
                    if (this.length && (r = X.get(o), 1 === o.nodeType && !Y.get(o, "hasDataAttrs"))) {
                        for (e = s.length; e--;) s[e] && 0 === (i = s[e].name).indexOf("data-") && (i = Q(i.slice(5)), J(o, i, r[i]));
            ...
            function ut(t, e) {
                for (var n, i, r, o, s, a, l, c = [], u = 0, h = t.length; u < h; u++)(i = t[u]).style && (n = i.style.display, e ? ("none" === n && (c[u] = Y.get(i, "display") || null, c[u] || (i.style.display = "")), "" === i.style.display && at(i) && (c[u] = (l = s = o = void 0, s = (r = i).ownerDocument, a = r.nodeName, (l = ct[a]) || (o = s.body.appendChild(s.createElement(a)), l = T.css(o, "display"), o.parentNode.removeChild(o), "none" === l && (l = "block"), ct[a] = l)))) : "none" !== n && (c[u] = "none", Y.set(i, "display", n)));
            ...
            function wt(t, e, n, i, r) {
                for (var o, s, a, l, c, u, h = e.createDocumentFragment(), d = [], f = 0, p = t.length; f < p; f++)
                    if ((o = t[f]) || 0 === o)
                        if ("object" === b(o)) T.merge(d, o.nodeType ? [o] : o);
                        else if (_t.test(o)) {
                    for (s = s || h.appendChild(e.createElement("div")), a = (dt.exec(o) || ["", ""])[1].toLowerCase(), l = pt[a] || pt._default, s.innerHTML = l[1] + T.htmlPrefilter(o) + l[2], u = l[0]; u--;) s = s.lastChild;
                    T.merge(d, s.childNodes), (s = h.firstChild).textContent = ""
                } else d.push(e.createTextNode(o));
                for (h.textContent = "", f = 0; o = d[f++];)
                    if (i && -1 < T.inArray(o, i)) r && r.push(o);
                    else if (c = rt(o), s = gt(h.appendChild(o), "script"), c && mt(s), n)
            ...
            function At(t, r, o) {
                ...
                })) : void 0 === Y.get(t, r) && T.event.add(t, r, Ct)
            }
            T.event = {
                global: {},
                add: function(e, t, n, i, r) {
                    var o, s, a, l, c, u, h, d, f, p, g, m = Y.get(e);
                    if (m)
                        for (n.handler && (n = (o = n).handler, r = o.selector), r && T.find.matchesSelector(it, r), n.guid || (n.guid = T.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function(t) {
                                return void 0 !== T && T.event.triggered !== t.type ? T.event.dispatch.apply(e, arguments) : void 0
                            }), c = (t = (t || "").match(P) || [""]).length; c--;) f = g = (a = Et.exec(t[c]) || [])[1], p = (a[2] || "").split(".").sort(), f && (h = T.event.special[f] || {}, f = (r ? h.delegateType : h.bindType) || f, h = T.event.special[f] || {}, u = T.extend({
                            type: f,
                            origType: g,
                            data: i,
                            handler: n,
                            ...
                            namespace: p.join(".")
                        }, o), (d = l[f]) || ((d = l[f] = []).delegateCount = 0, h.setup && !1 !== h.setup.call(e, i, p, s) || e.addEventListener && e.addEventListener(f, s)), h.add && (h.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? d.splice(d.delegateCount++, 0, u) : d.push(u), T.event.global[f] = !0)
                },
                remove: function(t, e, n, i, r) {
                    var o, s, a, l, c, u, h, d, f, p, g, m = Y.hasData(t) && Y.get(t);
                    if (m && (l = m.events)) {
                        for (c = (e = (e || "").match(P) || [""]).length; c--;)
                            if (f = g = (a = Et.exec(e[c]) || [])[1], p = (a[2] || "").split(".").sort(), f) {
                                for (h = T.event.special[f] || {}, d = l[f = (i ? h.delegateType : h.bindType) || f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = d.length; o--;) u = d[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (d.splice(o, 1), u.selector && d.delegateCount--, h.remove && h.remove.call(t, u));
                ...
                special: {
                    ...
                    click: {
                        setup: function(t) {
                            var e = this || t;
                            return ht.test(e.type) && e.click && D(e, "input") && At(e, "click", Ct), !1
                        },
                        trigger: function(t) {
                            var e = this || t;
                        ...
                        _default: function(t) {
                            var e = t.target;
                            return ht.test(e.type) && e.click && D(e, "input") && Y.get(e, "click") || D(e, "a")
                        }
                    },
                    beforeunload: {
            ...
            function Ht(t, e) {
                var n, i, r, o, s, a, l, c;
                if (1 === e.nodeType) {
                    if (Y.hasData(t) && (o = Y.access(t), s = Y.set(e, o), c = o.events))
            ...
            function Mt(n, i, r, o) {
                ...
                var t, e, s, a, l, c, u = 0,
                    ...
                    f = i[0],
                    p = _(f);
                if (p || 1 < h && "string" == typeof f && !y.checkClone && kt.test(f)) return n.each(function(t) {
                    var e = n.eq(t);
                    p && (i[0] = f.call(this, t, e.html())), Mt(e, i, r, o)
                });
                if (h && (e = (t = wt(i, n[0].ownerDocument, !1, n, o)).firstChild, 1 === t.childNodes.length && (t = e), e || o)) {
                    for (a = (s = T.map(gt(t, "script"), Lt)).length; u < h; u++) l = t, u !== d && (l = T.clone(l, !0, !0), a && T.merge(s, gt(l, "script"))), r.call(n[u], l, u);
                    if (a)
            ...
            function Rt(t, e, n) {
                for (var i, r = e ? T.filter(e, t) : t, o = 0; null != (i = r[o]); o++) n || 1 !== i.nodeType || T.cleanData(gt(i)), i.parentNode && (n && rt(i) && mt(gt(i, "script")), i.parentNode.removeChild(i));
                return t
            }
            T.extend({
                ...
                clone: function(t, e, n) {
                    ...
                    if (!(y.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || T.isXMLDoc(t)))
                        for (s = gt(u), i = 0, r = (o = gt(t)).length; i < r; i++) a = o[i], l = s[i], "input" === (c = l.nodeName.toLowerCase()) && ht.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
                    if (e)
                        if (n)
                            for (o = o || gt(t), s = s || gt(u), i = 0, r = o.length; i < r; i++) Ht(o[i], s[i]);
                        else Ht(t, u);
                ...
                html: function(t) {
                    return F(this, function(t) {
                        ...
                        if ("string" == typeof t && !It.test(t) && !pt[(dt.exec(t) || ["", ""])[1].toLowerCase()]) {
                            t = T.htmlPrefilter(t);
                            try {
            ...
            var qt, $t, Wt, Ft, zt, Bt, Ut, Qt = new RegExp("^(" + tt + ")(?!px)[a-z%]+$", "i"),
                Vt = function(t) {
                    var e = t.ownerDocument.defaultView;
                    return e && e.opener || (e = E), e.getComputedStyle(t)
                },
                Kt = new RegExp(nt.join("|"), "i");

            function Yt() {
                if (Ut) {
                    Bt.style.cssText = "position:absolute;left:-11111px;width:60px;margin-top:1px;padding:0;border:0", Ut.style.cssText = "position:relative;display:block;box-sizing:border-box;overflow:scroll;margin:auto;border:1px;padding:1px;width:60%;top:1%", it.appendChild(Bt).appendChild(Ut);
                    var t = E.getComputedStyle(Ut);
                    qt = "1%" !== t.top, zt = 12 === Xt(t.marginLeft), Ut.style.right = "60%", Ft = 36 === Xt(t.right), $t = 36 === Xt(t.width), Ut.style.position = "absolute", Wt = 12 === Xt(Ut.offsetWidth / 3), it.removeChild(Bt), Ut = null
                }
            }
            ...
            function Gt(t, e, n) {
                ...
                return (n = n || Vt(t)) && ("" !== (s = n.getPropertyValue(e) || n[e]) || rt(t) || (s = T.style(t, e)), !y.pixelBoxStyles() && Qt.test(s) && Kt.test(e) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s
            }
            ...
            Bt = C.createElement("div"), (Ut = C.createElement("div")).style && (Ut.style.backgroundClip = "content-box", Ut.cloneNode(!0).style.backgroundClip = "", y.clearCloneStyle = "content-box" === Ut.style.backgroundClip, T.extend(y, {
            ...
            function ce(t, e, n) {
                ...
                return (!y.boxSizingReliable() && r || "auto" === s || !parseFloat(s) && "inline" === T.css(t, "display", !1, i)) && t.getClientRects().length && (r = "border-box" === T.css(t, "boxSizing", !1, i), (o = a in t) && (s = t[a])), (s = parseFloat(s) || 0) + le(t, e, n || (r ? "border" : "content"), o, i, s) + "px"
            }
            ...
            T.extend({
                ...
                style: function(t, e, n, i) {
                    if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                        var r, o, s, a = Q(e),
                            l = re.test(e),
                            c = t.style;
                        if (l || (e = ne(a)), s = T.cssHooks[e] || T.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (r = s.get(t, !1, i)) ? r : c[e];
                        "string" === (o = typeof n) && (r = et.exec(n)) && r[1] && (n = lt(t, e, r), o = "number"), null != n && n == n && ("number" !== o || l || (n += r && r[3] || (T.cssNumber[a] ? "" : "px")), y.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (c[e] = "inherit"), s && "set" in s && void 0 === (n = s.set(t, n, i)) || (l ? c.setProperty(e, n) : c[e] = n))
                    }
                },
                css: function(t, e, n, i) {
                    var r, o, s, a = Q(e);
                    return re.test(e) || (e = ne(a)), (s = T.cssHooks[e] || T.cssHooks[a]) && "get" in s && (r = s.get(t, !0, n)), void 0 === r && (r = Gt(t, e, i)), "normal" === r && e in se && (r = se[e]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
                }
            }), T.each(["height", "width"], function(t, l) {
                T.cssHooks[l] = {
                    get: function(t, e, n) {
                        if (e) return !ie.test(T.css(t, "display")) || t.getClientRects().length && t.getBoundingClientRect().width ? ce(t, l, n) : st(t, oe, function() {
                            return ce(t, l, n)
                        })
                    },
                    set: function(t, e, n) {
                        var i, r = Vt(t),
                            ...
                            a = n ? le(t, l, n, s, r) : 0;
                        return s && o && (a -= Math.ceil(t["offset" + l[0].toUpperCase() + l.slice(1)] - parseFloat(r[l]) - le(t, l, "border", !1, r) - .5)), a && (i = et.exec(e)) && "px" !== (i[3] || "px") && (t.style[l] = e, e = T.css(t, l)), ae(0, e, a)
                    }
                }
            }), T.cssHooks.marginLeft = Zt(y.reliableMarginLeft, function(t, e) {
                if (e) return (parseFloat(Gt(t, "marginLeft")) || t.getBoundingClientRect().left - st(t, {
                    marginLeft: 0
                }, function() {
                ...
                }, "margin" !== r && (T.cssHooks[r + o].set = ae)
            }), T.fn.extend({
                css: function(t, e) {
                    return F(this, function(t, e, n) {
                        var i, r, o = {},
                            s = 0;
                        if (Array.isArray(e)) {
                            for (i = Vt(t), r = e.length; s < r; s++) o[e[s]] = T.css(t, e[s], !1, i);
                            return o
                        }
            ...
            function ve() {
                de && (!1 === C.hidden && E.requestAnimationFrame ? E.requestAnimationFrame(ve) : E.setTimeout(ve, T.fx.interval), T.fx.tick())
            }
            ...
            function be(o, t, e) {
                var n, s, i = 0,
                    ...
                    l = function() {
                        if (s) return !1;
                        for (var t = he || ye(), e = Math.max(0, c.startTime + c.duration - t), n = 1 - (e / c.duration || 0), i = 0, r = c.tweens.length; i < r; i++) c.tweens[i].run(n);
                ...
                for (! function(t, e) {
                        var n, i, r, o, s;
                        for (n in t)
                            if (r = e[i = Q(n)], o = t[n], Array.isArray(o) && (r = o[1], o = t[n] = o[0]), n !== i && (t[i] = o, delete t[n]), (s = T.cssHooks[i]) && "expand" in s)
                                for (n in o = s.expand(o), delete t[i], o) n in t || (t[n] = o[n], e[n] = r);
                            else e[i] = r
                    }(u, c.opts.specialEasing); i < r; i++)
                    if (n = be.prefilters[i].call(c, o, u, c.opts)) return _(n.stop) && (T._queueHooks(c.elem, c.opts.queue).stop = n.stop.bind(n)), n;
                return T.map(u, we, c), _(c.opts.start) && c.opts.start.call(o, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), T.fx.timer(T.extend(l, {
                    elem: o,
                    anim: c,
                    queue: c.opts.queue
                })), c
            ...
            T.Animation = T.extend(be, {
                ...
                tweener: function(t, e) {
                    for (var n, i = 0, r = (t = _(t) ? (e = t, ["*"]) : t.match(P)).length; i < r; i++) n = t[i], be.tweeners[n] = be.tweeners[n] || [], be.tweeners[n].unshift(e)
                },
                prefilters: [function(t, e, n) {
                    ...
                    if ((l = !T.isEmptyObject(e)) || !T.isEmptyObject(f))
                        for (i in h && 1 === t.nodeType && (n.overflow = [p.overflow, p.overflowX, p.overflowY], null == (c = m && m.display) && (c = Y.get(t, "display")), "none" === (u = T.css(t, "display")) && (c ? u = c : (ut([t], !0), c = t.style.display || c, u = T.css(t, "display"), ut([t]))), ("inline" === u || "inline-block" === u && null != c) && "none" === T.css(t, "float") && (l || (d.done(function() {
                                p.display = c
                            ...
                            for (i in g || ut([t]), Y.remove(t, "fxshow"), f) T.style(t, i, f[i])
                ...
                T.fn[i] = function(t, e, n) {
                    return null == t || "boolean" == typeof t ? r.apply(this, arguments) : this.animate(_e(i, !0), t, e, n)
                }
            }), T.each({
                slideDown: _e("show"),
                slideUp: _e("hide"),
            ...
            }, fe = C.createElement("input"), pe = C.createElement("select").appendChild(C.createElement("option")), fe.type = "checkbox", y.checkOn = "" !== fe.value, y.optSelected = pe.selected, (fe = C.createElement("input")).value = "t", fe.type = "radio", y.radioValue = "t" === fe.value;
            var xe, Ee = T.expr.attrHandle;
            T.fn.extend({
                attr: function(t, e) {
                ...
                attr: function(t, e, n) {
                    ...
                    if (3 !== o && 8 !== o && 2 !== o) return void 0 === t.getAttribute ? T.prop(t, e, n) : (1 === o && T.isXMLDoc(t) || (r = T.attrHooks[e.toLowerCase()] || (T.expr.match.bool.test(e) ? xe : void 0)), void 0 !== n ? null === n ? void T.removeAttr(t, e) : r && "set" in r && void 0 !== (i = r.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : !(r && "get" in r && null !== (i = r.get(t, e))) && null == (i = T.find.attr(t, e)) ? void 0 : i)
                },
                attrHooks: {
                    type: {
                        set: function(t, e) {
            ...
            T.fn.extend({
                ...
                toggleClass: function(r, e) {
                    ...
                    return "boolean" == typeof e && s ? e ? this.addClass(r) : this.removeClass(r) : _(r) ? this.each(function(t) {
                        T(this).toggleClass(r.call(this, t, De(this), e), e)
                    }) : this.each(function() {
                        var t, e, n, i;
                        if (s)
                            for (e = 0, n = T(this), i = Ae(r); t = i[e++];) n.hasClass(t) ? n.removeClass(t) : n.addClass(t);
                ...
                hasClass: function(t) {
                    var e, n, i = 0;
                    for (e = " " + t + " "; n = this[i++];)
                        if (1 === n.nodeType && -1 < (" " + Se(De(n)) + " ").indexOf(e)) return !0;
                    return !1
                }
            });
            var Ne = /\r/g;
            T.fn.extend({
                val: function(n) {
                    ...
                    })) : e ? (i = T.valHooks[e.type] || T.valHooks[e.nodeName.toLowerCase()]) && "get" in i && void 0 !== (t = i.get(e, "value")) ? t : "string" == typeof(t = e.value) ? t.replace(Ne, "") : null == t ? "" : t : void 0
                }
            }), T.extend({
                valHooks: {
                    option: {
            ...
            T.extend(T.event, {
                trigger: function(t, e, n, i) {
                    var r, o, s, a, l, c, u, h, d = [n || C],
                        f = v.call(t, "type") ? t.type : t,
                        p = v.call(t, "namespace") ? t.namespace.split(".") : [];
                    if (o = h = s = n = n || C, 3 !== n.nodeType && 8 !== n.nodeType && !ke.test(f + T.event.triggered) && (-1 < f.indexOf(".") && (f = (p = f.split(".")).shift(), p.sort()), l = f.indexOf(":") < 0 && "on" + f, (t = t[T.expando] ? t : new T.Event(f, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = n), e = null == e ? [t] : T.makeArray(e, [t]), u = T.event.special[f] || {}, i || !u.trigger || !1 !== u.trigger.apply(n, e))) {
                        if (!i && !u.noBubble && !g(n)) {
                            for (a = u.delegateType || f, ke.test(a + f) || (o = o.parentNode); o; o = o.parentNode) d.push(o), s = o;
                            s === (n.ownerDocument || C) && d.push(s.defaultView || s.parentWindow || E)
                        }
                        for (r = 0;
                            (o = d[r++]) && !t.isPropagationStopped();) h = o, t.type = 1 < r ? a : u.bindType || f, (c = (Y.get(o, "events") || {})[t.type] && Y.get(o, "handle")) && c.apply(o, e), (c = l && o[l]) && c.apply && V(o) && (t.result = c.apply(o, e), !1 === t.result && t.preventDefault());
                        return t.type = f, i || t.isDefaultPrevented() || u._default && !1 !== u._default.apply(d.pop(), e) || !V(n) || l && _(n[f]) && !g(n) && ((s = n[l]) && (n[l] = null), T.event.triggered = f, t.isPropagationStopped() && h.addEventListener(f, Ie), n[f](), t.isPropagationStopped() && h.removeEventListener(f, Ie), T.event.triggered = void 0, s && (n[l] = s)), t.result
                    }
                },
            ...
            function qe(n, t, i, r) {
                ...
                if (Array.isArray(t)) T.each(t, function(t, e) {
                    i || Pe.test(n) ? r(n, e) : qe(n + "[" + ("object" == typeof e && null != e ? t : "") + "]", e, i, r)
                });
                else if (i || "object" !== b(t)) r(n, t);
                else
                    for (e in t) qe(n + "[" + e + "]", t[e], i, r)
            }
            ...
            Ye.href = Oe.href, T.extend({
                ...
                ajax: function(t, e) {
                    ...
                    var u, h, d, n, f, i, p, g, r, o, m = T.ajaxSetup({}, e),
                        v = m.context || m,
                        ...
                        x = {
                            ...
                            getResponseHeader: function(t) {
                                ...
                                if (p) {
                                    if (!n)
                                        for (n = {}; e = ze.exec(d);) n[e[1].toLowerCase() + " "] = (n[e[1].toLowerCase() + " "] || []).concat(e[2]);
                                    e = n[t.toLowerCase() + " "]
                                }
                    ...
                    if (_.promise(x), m.url = ((t || m.url || Oe.href) + "").replace(Ue, Oe.protocol + "//"), m.type = e.method || e.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(P) || [""], null == m.crossDomain) {
                        i = C.createElement("a");
                        try {
                    ...
                    if (m.data && m.processData && "string" != typeof m.data && (m.data = T.param(m.data, m.traditional)), Ge(Qe, m, e, x), p) return x;
                    for (r in (g = T.event && m.global) && 0 == T.active++ && T.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !Be.test(m.type), h = m.url.replace(We, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace($e, "+")) : (o = m.url.slice(h.length), m.data && (m.processData || "string" == typeof m.data) && (h += (Le.test(h) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (h = h.replace(Fe, "$1"), o = (Le.test(h) ? "&" : "?") + "_=" + je++ + o), m.url = h + o), m.ifModified && (T.lastModified[h] && x.setRequestHeader("If-Modified-Since", T.lastModified[h]), T.etag[h] && x.setRequestHeader("If-None-Match", T.etag[h])), (m.data && m.hasContent && !1 !== m.contentType || e.contentType) && x.setRequestHeader("Content-Type", m.contentType), x.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + Ke + "; q=0.01" : "") : m.accepts["*"]), m.headers) x.setRequestHeader(r, m.headers[r]);
                    if (m.beforeSend && (!1 === m.beforeSend.call(v, x, m) || p)) return x.abort();
                    if (l = "abort", w.add(m.complete), x.done(m.success), x.fail(m.error), u = Ge(Ve, m, e, x)) {
                    ...
                    function c(t, e, n, i) {
                        var r, o, s, a, l, c = e;
                        p || (p = !0, f && E.clearTimeout(f), u = void 0, d = i || "", x.readyState = 0 < t ? 4 : 0, r = 200 <= t && t < 300 || 304 === t, n && (a = function(t, e, n) {
            ...
            T.ajaxSetup({
                ...
                if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = _(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(rn, "$1" + i) : !1 !== t.jsonp && (t.url += (Le.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
                    return o || T.error(i + " was not called"), o[0]
                }, t.dataTypes[0] = "json", r = E[i], E[i] = function() {
                    o = arguments
                }, n.always(function() {
                    void 0 === r ? T(E).removeProp(i) : E[i] = r, t[i] && (t.jsonpCallback = e.jsonpCallback, nn.push(i)), o && _(r) && r(o[0]), o = r = void 0
                }), "script"
            }), y.createHTMLDocument = ((en = C.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === en.childNodes.length), T.parseHTML = function(t, e, n) {
                return "string" != typeof t ? [] : ("boolean" == typeof e && (n = e, e = !1), e || (y.createHTMLDocument ? ((i = (e = C.implementation.createHTMLDocument("")).createElement("base")).href = C.location.href, e.head.appendChild(i)) : e = C), o = !n && [], (r = A.exec(t)) ? [e.createElement(r[1])] : (r = wt([t], e, o), o && o.length && T(o).remove(), T.merge([], r.childNodes)));
                var i, r, o
            }, T.fn.load = function(t, e, n) {
                var i, r, o, s = this,
                    a = t.indexOf(" ");
                return -1 < a && (i = Se(t.slice(a)), t = t.slice(0, a)), _(e) ? (n = e, e = void 0) : e && "object" == typeof e && (r = "POST"), 0 < s.length && T.ajax({
                    url: t,
                    type: r || "GET",
                    dataType: "html",
                    data: e
                ...
                setOffset: function(t, e, n) {
                    var i, r, o, s, a, l, c = T.css(t, "position"),
                        u = T(t),
                        h = {};
                    "static" === c && (t.style.position = "relative"), a = u.offset(), o = T.css(t, "top"), l = T.css(t, "left"), r = ("absolute" === c || "fixed" === c) && -1 < (o + l).indexOf("auto") ? (s = (i = u.position()).top, i.left) : (s = parseFloat(o) || 0, parseFloat(l) || 0), _(e) && (e = e.call(t, n, T.extend({}, a))), null != e.top && (h.top = e.top - a.top + s), null != e.left && (h.left = e.left - a.left + r), "using" in e ? e.using.call(t, h) : u.css(h)
                }
            }, T.fn.extend({
                offset: function(e) {
                ...
                T.cssHooks[n] = Zt(y.pixelPosition, function(t, e) {
                    if (e) return e = Gt(t, n), Qt.test(e) ? T(t).position()[n] + "px" : e
                })
            }), T.each({
                Height: "height",
                Width: "width"
            ...
            }, T.isArray = Array.isArray, T.parseJSON = JSON.parse, T.nodeName = D, T.isFunction = _, T.isWindow = g, T.camelCase = Q, T.type = b, T.now = Date.now, T.isNumeric = function(t) {
                var e = T.type(t);
            ...
            return T.noConflict = function(t) {
                return E.$ === T && (E.$ = sn), t && E.jQuery === T && (E.jQuery = on), T
            }, t || (E.jQuery = E.$ = T), T
        })
    }, {}],
    3: [function(t, e, n) {
        ...
        var c, i, r, a, o, s, u, h, d, f, p, g, m, v, y, _, w, b, x, E, C, T, S, D, A, N, I, k, O, j;

        function L(t, n) {
            var i = !1,
                e = t.charAt(0).toUpperCase() + t.slice(1);
            return S.each((t + " " + N.join(e + " ") + e).split(" "), function(t, e) {
                if (A[e] !== D) return i = !n || e, !1
            }), i
        }
        ...
        c = window.Zepto || window.jQuery, i = window, r = document, l.Defaults = {
                items: 3,
                loop: !1,
                center: !1,
                rewind: !1,
                ...
                c.support.transition && this.$stage.on(c.support.transition.end + ".owl.core", c.proxy(this.onTransitionEnd, this)), !1 !== this.settings.responsive && this.on(i, "resize", this._handlers.onThrottledResize), this.settings.mouseDrag && (this.$element.addClass(this.options.dragClass), this.$stage.on("mousedown.owl.core", c.proxy(this.onDragStart, this)), this.$stage.on("dragstart.owl.core selectstart.owl.core", function() {
                    return !1
                ...
                var t;
                return this.options.responsiveBaseElement !== i ? t = c(this.options.responsiveBaseElement).width() : i.innerWidth ? t = i.innerWidth : r.documentElement && r.documentElement.clientWidth ? t = r.documentElement.clientWidth : console.warn("Can not detect viewport width."), t
                ...
                for (var t in this.$element.off(".owl.core"), this.$stage.off(".owl.core"), c(r).off(".owl.core"), !1 !== this.settings.responsive && (i.clearTimeout(this.resizeTimer), this.off(i, "resize", this._handlers.onThrottledResize)), this._plugins) this._plugins[t].destroy();
            ...
            }, c.fn.owlCarousel.Constructor = l, o = window.Zepto || window.jQuery, s = window, document, (u = function(t) {
                this._core = t, this._interval = null, this._visible = null, this._handlers = {
                    "initialized.owl.carousel": o.proxy(function(t) {
                        t.namespace && this._core.settings.autoRefresh && this.watch()
                    }, this)
                }, this._core.options = o.extend({}, u.Defaults, this._core.options), this._core.$element.on(this._handlers)
            }).Defaults = {
                autoRefresh: !0,
                autoRefreshInterval: 500
            }, u.prototype.watch = function() {
                this._interval || (this._visible = this._core.isVisible(), this._interval = s.setInterval(o.proxy(this.refresh, this), this._core.settings.autoRefreshInterval))
            ...
            }, o.fn.owlCarousel.Constructor.Plugins.AutoRefresh = u, h = window.Zepto || window.jQuery, d = window, document, (f = function(t) {
                this._core = t, this._loaded = [], this._handlers = {
                    "initialized.owl.carousel change.owl.carousel resized.owl.carousel": h.proxy(function(t) {
                        if (t.namespace && this._core.settings && this._core.settings.lazyLoad && (t.property && "position" == t.property.name || "initialized" == t.type)) {
                            var e = this._core.settings,
                                ...
                                s = h.proxy(function(t, e) {
                                    this.load(e)
                                }, this);
                            for (0 < e.lazyLoadEager && (n += e.lazyLoadEager, e.loop && (r -= e.lazyLoadEager, n++)); i++ < n;) this.load(o / 2 + this._core.relative(r)), o && h.each(this._core.clones(this._core.relative(r)), s), r++
                        }
                    }, this)
                }, this._core.options = h.extend({}, f.Defaults, this._core.options), this._core.$element.on(this._handlers)
            }).Defaults = {
                lazyLoad: !1,
                lazyLoadEager: 0
                ...
                var e = this._core.$stage.children().eq(t),
                    n = e && e.find(".owl-lazy");
                !n || -1 < h.inArray(e.get(0), this._loaded) || (n.each(h.proxy(function(t, e) {
                    var n, i = h(e),
                        r = 1 < d.devicePixelRatio && i.attr("data-src-retina") || i.attr("data-src") || i.attr("data-srcset");
                    this._core.trigger("load", {
                        element: i,
                        url: r
                    }, "lazy"), i.is("img") ? i.one("load.owl.lazy", h.proxy(function() {
                        i.css("opacity", 1), this._core.trigger("loaded", {
                            element: i,
                            url: r
                        }, "lazy")
                    }, this)).attr("src", r) : i.is("source") ? i.one("load.owl.lazy", h.proxy(function() {
                        this._core.trigger("loaded", {
                            element: i,
                            url: r
                        }, "lazy")
                    }, this)).attr("srcset", r) : ((n = new Image).onload = h.proxy(function() {
                        i.css({
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, h.fn.owlCarousel.Constructor.Plugins.Lazy = f, p = window.Zepto || window.jQuery, g = window, document, (m = function(t) {
                this._core = t, this._previousHeight = null, this._handlers = {
                    ...
                    "loaded.owl.lazy": p.proxy(function(t) {
                        t.namespace && this._core.settings.autoHeight && t.element.closest("." + this._core.settings.itemClass).index() === this._core.current() && this.update()
                    }, this)
                }, this._core.options = p.extend({}, m.Defaults, this._core.options), this._core.$element.on(this._handlers), this._intervalId = null;
                var e = this;
                p(g).on("load", function() {
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, p.fn.owlCarousel.Constructor.Plugins.AutoHeight = m, v = window.Zepto || window.jQuery, window, y = document, (_ = function(t) {
                this._core = t, this._videos = {}, this._playing = null, this._handlers = {
                    ...
                    "resize.owl.carousel": v.proxy(function(t) {
                        t.namespace && this._core.settings.video && this.isInFullScreen() && t.preventDefault()
                    }, this),
                    "refreshed.owl.carousel": v.proxy(function(t) {
                        t.namespace && this._core.is("resizing") && this._core.$stage.find(".cloned .owl-video-frame").remove()
                    }, this),
                    "changed.owl.carousel": v.proxy(function(t) {
                        t.namespace && "position" === t.property.name && this._playing && this.stop()
                    }, this),
                    "prepared.owl.carousel": v.proxy(function(t) {
                        if (t.namespace) {
                            var e = v(t.content).find(".owl-video");
                            e.length && (e.css("display", "none"), this.fetch(e, v(t.content)))
                        }
                    }, this)
                }, this._core.options = v.extend({}, _.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", v.proxy(function(t) {
                    this.play(t)
                }, this))
            }).Defaults = {
                video: !1,
                videoHeight: !1,
                videoWidth: !1
            }, _.prototype.fetch = function(t, e) {
            ...
            }, _.prototype.thumbnail = function(e, t) {
                function n(t) {
                    i = c.lazyLoad ? v("<div/>", {
                ...
                "youtube" === t.type ? (r = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg", n(r)) : "vimeo" === t.type ? v.ajax({
                    type: "GET",
                ...
                var e, n = v(t.target).closest("." + this._core.settings.itemClass),
                    i = this._videos[n.attr("data-video")],
                    r = i.width || "100%",
                    o = i.height || this._core.$stage.height();
                this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), n = this._core.items(this._core.relative(n.index())), this._core.reset(n.index()), (e = v('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o), e.attr("width", r), "youtube" === i.type ? e.attr("src", "//www.youtube.com/embed/" + i.id + "?autoplay=1&rel=0&v=" + i.id) : "vimeo" === i.type ? e.attr("src", "//player.vimeo.com/video/" + i.id + "?autoplay=1") : "vzaar" === i.type && e.attr("src", "//view.vzaar.com/" + i.id + "/player?autoplay=true"), v(e).wrap('<div class="owl-video-frame" />').insertAfter(n.find(".owl-video")), this._playing = n.addClass("owl-video-playing"))
            }, _.prototype.isInFullScreen = function() {
                var t = y.fullscreenElement || y.mozFullScreenElement || y.webkitFullscreenElement;
                return t && v(t).parent().hasClass("owl-video-frame")
            }, _.prototype.destroy = function() {
                var t, e;
                for (t in this._core.$element.off("click.owl.video"), this._handlers) this._core.$element.off(t, this._handlers[t]);
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, v.fn.owlCarousel.Constructor.Plugins.Video = _, w = window.Zepto || window.jQuery, window, document, (b = function(t) {
                this.core = t, this.core.options = w.extend({}, b.Defaults, this.core.options), this.swapping = !0, this.previous = void 0, this.next = void 0, this.handlers = {
                    "change.owl.carousel": w.proxy(function(t) {
                        t.namespace && "position" == t.property.name && (this.previous = this.core.current(), this.next = t.property.value)
                    }, this),
                    "drag.owl.carousel dragged.owl.carousel translated.owl.carousel": w.proxy(function(t) {
                        t.namespace && (this.swapping = "translated" == t.type)
                    }, this),
                    "translate.owl.carousel": w.proxy(function(t) {
                ...
                if (1 === this.core.settings.items && w.support.animation && w.support.transition) {
                    this.core.speed(0);
                    var t, e = w.proxy(this.clear, this),
                        n = this.core.$stage.children().eq(this.previous),
                        i = this.core.$stage.children().eq(this.next),
                        r = this.core.settings.animateIn,
                        o = this.core.settings.animateOut;
                    this.core.current() !== this.previous && (o && (t = this.core.coordinates(this.previous) - this.core.coordinates(this.next), n.one(w.support.animation.end, e).css({
                        left: t + "px"
                    }).addClass("animated owl-animated-out").addClass(o)), r && i.one(w.support.animation.end, e).addClass("animated owl-animated-in").addClass(r))
                }
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, w.fn.owlCarousel.Constructor.Plugins.Animate = b, x = window.Zepto || window.jQuery, E = window, C = document, (T = function(t) {
                ...
                this._call = E.setTimeout(x.proxy(this._next, this, t), this._timeout * (Math.round(this.read() / this._timeout) + 1) - this.read()), this._core.is("interacting") || C.hidden || this._core.next(t || this._core.settings.autoplaySpeed)
            }, T.prototype.read = function() {
                return (new Date).getTime() - this._time
            }, T.prototype.play = function(t, e) {
                var n;
                this._core.is("rotating") || this._core.enter("rotating"), t = t || this._core.settings.autoplayTimeout, n = Math.min(this._time % (this._timeout || t), t), this._paused ? (this._time = this.read(), this._paused = !1) : E.clearTimeout(this._call), this._time += this.read() % t - n, this._timeout = t, this._call = E.setTimeout(x.proxy(this._next, this, e), t - n)
                ...
                for (e in Object.getOwnPropertyNames(this)) "function" != typeof this[e] && (this[e] = null)
            }, x.fn.owlCarousel.Constructor.Plugins.autoplay = T,
            function(o) {
                "use strict";
                var e = function(t) {
            ...
            }(window.Zepto || window.jQuery, window, document), S = window.Zepto || window.jQuery, window, D = void document, A = S("<support>").get(0).style, N = "Webkit Moz O ms".split(" "), I = {
                transition: {
                    end: {
            ...
            function() {
                return !!L("transition")
            }() && (S.support.transition = new String(P("transition")), S.support.transition.end = I.transition.end[S.support.transition]), j() && (S.support.animation = new String(P("animation")), S.support.animation.end = I.animation.end[S.support.animation]), k() && (S.support.transform = new String(P("transform")), S.support.transform3d = O())
    }, {}],
    4: [function(t, n, i) {
        (function(tt) {
            var t, e;
            t = this, e = function() {
                ...
                function g(t) {
                    ...
                    var e = w(t),
                        ...
                        i = e.overflowX,
                        r = e.overflowY;
                    return /(auto|scroll|overlay)/.test(n + r + i) ? t : g(p(t))
                }
                ...
                function _(t) {
                    ...
                    var i = n && n.nodeName;
                    return i && "BODY" !== i && "HTML" !== i ? -1 !== ["TH", "TD", "TABLE"].indexOf(n.nodeName) && "static" === w(n, "position") ? _(n) : n : t ? t.ownerDocument.documentElement : document.documentElement
                }
                ...
                function y(t, e) {
                    ...
                    if (t !== l && e !== l || i.contains(r)) return "BODY" === (a = (s = l).nodeName) || "HTML" !== a && _(s.firstElementChild) !== s ? _(l) : l;
                    var c = u(t);
                ...
                function D(t, e, n) {
                    ...
                    return (r && !i ? e.contains(l) : e === l && "BODY" !== l.nodeName) && (d = function(t, e, n) {
                        var i = 2 < arguments.length && void 0 !== n && n,
                            r = b(e, "top"),
                            o = b(e, "left"),
                            s = i ? -1 : 1;
                ...
                function j(t, n, e) {
                    return (void 0 === e ? t : t.slice(0, function(t, e, n) {
                        ...
                        t.enabled && s(e) && (n.offsets.popper = T(n.offsets.popper), n.offsets.reference = T(n.offsets.reference), n = e(n, t))
                    }), n
                }
                ...
                function $(n, i) {
                    Object.keys(i).forEach(function(t) {
                        var e = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && q(i[t]) && (e = "px"), n.style[t] = i[t] + e
                    })
                }
                ...
                function W(t, e) {
                    ...
                    var i = t.offsets,
                        ...
                        f = e ? s : n;
                    return {
                        left: d(l % 2 == 1 && c % 2 == 1 && !h && e ? r.left - 1 : r.left),
                        top: f(r.top),
                        bottom: f(r.bottom),
                        right: d(r.right)
                    }
                        ...
                        modifiers: {
                            ...
                            offset: {
                                ...
                                fn: function(t, e) {
                                    var n = e.offset,
                                        ...
                                        a = i.split("-")[0],
                                        l = void 0;
                                    return l = q(+n) ? [+n, 0] : X(n, o, s, a), "left" === a ? (o.top += l[0], o.left -= l[1]) : "right" === a ? (o.top += l[0], o.left += l[1]) : "top" === a ? (o.left += l[0], o.top -= l[1]) : "bottom" === a && (o.left += l[0], o.top += l[1]), t.popper = o, t
                                },
                                offset: 0
                            },
                            preventOverflow: {
                                ...
                                fn: function(t, i) {
                                    ...
                                    var c = i.priority,
                                        ...
                                        h = {
                                            primary: function(t) {
                                                var e = u[t];
                                                return u[t] < l[t] && !i.escapeWithReference && (e = Math.max(u[t], l[t])), E({}, t, e)
                                            },
                                            secondary: function(t) {
                                                var e = "right" === t ? "left" : "top",
                                                    n = u[e];
                                                return u[t] > l[t] && !i.escapeWithReference && (n = Math.min(u[e], l[t] - ("right" === t ? u.width : u.height))), E({}, e, n)
                                            }
                                        };
                            ...
                            arrow: {
                                ...
                                fn: function(t, e) {
                                    ...
                                    return _ = Math.max(Math.min(s[c] - p, _), 0), t.arrowElement = i, t.offsets.arrow = (E(n = {}, h, Math.round(_)), E(n, d, ""), n), t
                                },
                                element: "[x-arrow]"
                            },
                            flip: {
                                ...
                                enabled: !0,
                                fn: function(m, v) {
                                    if (L(m.instance.modifiers, "inner")) return m;
                                    ...
                                    return x.forEach(function(t, e) {
                                        ...
                                        var n, i = m.offsets.popper,
                                            ...
                                            f = !!v.flipVariations && (d && "start" === b && a || d && "end" === b && l || !d && "start" === b && c || !d && "end" === b && u),
                                            p = !!v.flipVariationsByContent && (d && "start" === b && l || d && "end" === b && a || !d && "start" === b && u || !d && "end" === b && c),
                                            g = f || p;
                                        (s || h || g) && (m.flipped = !0, (s || h) && (_ = x[e + 1]), g && (b = "end" === (n = b) ? "start" : "start" === n ? "end" : n), m.placement = _ + (b ? "-" + b : ""), m.offsets.popper = C({}, m.offsets.popper, k(m.instance.popper, m.offsets.reference, m.placement)), m = j(m.instance.modifiers, m, "flip"))
                                    }), m
                                },
                                behavior: "flip",
                                padding: 5,
                            ...
                            computeStyle: {
                                ...
                                fn: function(t, e) {
                                    ...
                                    var s = void 0 !== o ? o : e.gpuAcceleration,
                                        a = _(t.instance.popper),
                                        l = S(a),
                                        c = {
                                            position: r.position
                                        },
                                        u = W(t, window.devicePixelRatio < 2 || !F),
                        ...
                        value: function() {
                            return function() {
                                if (!this.state.isDestroyed) {
                                    ...
                                    t.offsets.reference = d(this.state, this.popper, this.reference, this.options.positionFixed), t.placement = c(this.options.placement, t.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), t.originalPlacement = t.placement, t.positionFixed = this.options.positionFixed, t.offsets.popper = k(this.popper, t.offsets.reference, t.placement), t.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", t = j(this.modifiers, t), this.state.isCreated ? this.options.onUpdate(t) : (this.state.isCreated = !0, this.options.onCreate(t))
                                }
                            }.call(this)
                        }
                    }, {
                ...
                return Z.Utils = ("undefined" != typeof window ? window : tt).PopperUtils, Z.placements = B, Z.Defaults = G, Z
            }, "object" == typeof i && void 0 !== n ? n.exports = e() : "function" == typeof define && define.amd ? define(e) : t.Popper = e()
    ...
    5: [function(i, t, e) {
        (function(t) {
            ...
            var e = t.jQuery;
            window.$ = e;
            var n = i("owl.carousel");
            window.fn = n, jQuery.fn.serializeAndEncode = function() {
                return jQuery.map(this.serializeArray(), function(t) {
                    return [t.name, encodeURIComponent(t.value)].join("=")
                }).join("&")
            };
            jQuery(document).ready(function(o) {
                var n = {
                        ...
                        header: o("#header"),
                        sticky_max: o(".sticky-max")
                    },
                    i = {
                        name: o('input[name="name"]').val(),
                        phone: o('input[name="phone"]').val(),
                        address: o('textarea[name="address"]').val(),
                        product_id: o(".input-product-id").val(),
                        product_amount: o(".input-amount").val(),
                        referer: o('input[name="referer"]').val()
                    };
                o.ajaxSetup({
                    url: "ajax.php",
                    type: "post",
                    ...
                    beforeSend: function(t, e) {
                        var n = "" == e.data ? {} : JSON.parse('{"' + decodeURI(e.data.replace(/&/g, '","').replace(/=/g, '":"')).replace(/(?:\r\n|\r|\n)/g, "\\n") + '"}');
                        e.data = o.param(o.extend(i, n))
                    }
                });
                var t = navigator.userAgent || navigator.vendor || window.opera;
                if (-1 < t.indexOf("Instagram")) {
                    var e = /Instagram\s([0-9]+)\./g.exec(t);
                    e && (e = parseInt(e[1])) < 136 && n.body.addClass("instagram-old-browser")
                }
                ...
                function r() {
                    ...
                    if (n.order.length && n.header.length) {
                        var e = (n.sticky_max.length ? n.sticky_max : n.order).offset().top - n.header.height();
                        100 <= t && t < e ? n.body.addClass("header-visible") : n.body.removeClass("header-visible")
                    }
                }

                function s(t, e, n) {
                    var i = "";
                    if (e > (t = t.toString()).length)
                        for (var r = 0; r < e - t.length; r++) i += n + "";
                    return i + t
                }
                var a = [];
                n.countdown.each(function(n) {
                    var i = o(this),
                        r = i.data("length") - 1;
                    a[n] = setInterval(function() {
                        var t, e;
                        (!r || r <= 0) && (r = 0, clearInterval(a[n])), e = r, (t = i).find(".hours").text(s(Math.floor(e / 60 / 60), 2, "0")), t.find(".minutes").text(s(Math.floor(e / 60 % 60), 2, "0")), t.find(".seconds").text(s(Math.floor(e % 60), 2, "0")), r--
                    }, 1e3)
                }), n.body.on("click change", "[data-product-id], [data-amount], select", function(t) {
                    var e = o(this);
                    "select" == e.prop("tagName").toLowerCase() && (e = e.find("option:selected"));
                    var i = e.data("amount"),
                        r = e.data("product-id");
                    "number" == typeof i && o(".input-amount").each(function() {
                        o(this).val(i)
                    }), "number" == typeof r && o(".input-product-id").each(function() {
                        o(this).val(r)
                    }), n.order.find(".radio").each(function() {
                        var t = o(this),
                            e = t.data("amount"),
                            n = t.data("product-id");
                        i == e && r == n && t.addClass("selected").siblings(".radio").removeClass("selected")
                    })
                }), n.body.on("click", ".btn-show-form", function(t) {
                    t.preventDefault();
                    var e = o(this),
                        n = e.parents(".comment-form");
                    n.hasClass("active") || (n.addClass("active"), e.remove())
                }), n.body.on("submit", ".form", function(t) {
                    t.preventDefault();
                    var e = o(this),
                        n = e.find(".btn-submit"),
                        i = e.data("form-type"),
                        r = n.data("loading-text");
                    n.is(":disabled") || (n.prop("disabled", !0), r && n.data("html", n.html()).html(o("<span>").addClass("loading").text(r)), "admin-general" == i && o(".alert-" + i).addClass("d-none"), o.ajax({
                        data: e.serializeAndEncode(),
                        complete: function(t, e) {
                            ("success" != e || t.responseJSON && !t.responseJSON.status || "order" != i) && n.prop("disabled", !1).html(n.data("html"))
                        },
                        success: function(t) {
                            if (t.status)
                                if ("comment" == i) e.removeClass("active").addClass("pending");
                                else if ("bsa" == i) e.addClass("success");
                            else {
                                if (-1 != ["order", "admin_login"].indexOf(i)) return void(t.url && (window.top.location = t.url));
                                "admin-general" == i && o(".alert-" + i).removeClass("d-none")
                            } else t.errors && function(t) {
                                for (var e in o(".is-invalid").each(function() {
                                        o(this).removeClass("is-invalid")
                                    }), t) {
                                    var n = o('[name="' + t[e] + '"]');
                                    n.length && n.parents(".form-block, .form-group").addClass("is-invalid")
                                }
                            }(t.errors)
                        }
                    }))
                }), n.body.on("blur", 'input[type="tel"]', function(t) {
                    var e = o(this).val().replace(/[^0-9]+/g, "");
                    "" != e && 10 <= e.toString().length && o.ajax({
                        data: {
                            phone: e,
                            action: "problem"
                        }
                    })
                }), n.body.on("click", '[href="#order"]', function(t) {
                    var e = n.sticky_max.length ? n.sticky_max : n.order;
                    e.length && (t.preventDefault(), window.scrollTo(0, e.offset().top))
                }), window.addEventListener("resize", r, !1), window.addEventListener("scroll", r, !1), setTimeout(r, 100), "function" == typeof themeCB && themeCB.call(this, o)
            })
        }).call(this, "undefined" != typeof global ? global : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {
        bootstrap: 1,
