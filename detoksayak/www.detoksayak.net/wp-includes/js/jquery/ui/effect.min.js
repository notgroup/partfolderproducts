...
! function(t) {
    ...
    var u, l, c, d, t, p, h, g, i, e, b, a, o, f, m, y, n, r, v, x, C = "ui-effects-",
        w = s;
    ...
    function k(i) {
        var s = p(),
            f = s._rgba = [];
        return i = i.toLowerCase(), b(t, function(t, e) {
            var n, r = e.re.exec(i),
                o = r && e.parse(r),
                a = e.space || "rgba";
    ...
    function j(t, e, n, r) {
        return s.isPlainObject(t) && (t = (e = t).effect), t = {
            effect: t
        }, null == e && (e = {}), s.isFunction(e) && (r = e, n = null, e = {}), "number" != typeof e && !s.fx.speeds[e] || (r = n, n = e, e = {}), s.isFunction(n) && (r = n, n = null), e && s.extend(t, e), n = n || e.duration, t.duration = s.fx.off ? 0 : "number" == typeof n ? n : n in s.fx.speeds ? s.fx.speeds[n] : s.fx.speeds._default, t.complete = r || e.complete, t
    }
        ...
        d = /^([\-+])=\s*(\d+\.?\d*)/, t = [{
            ...
            parse: function(o, t, e, n) {
                ...
                var a = this,
                    r = u.type(o),
                    i = this._rgba = [];
                return t !== l && (o = [o, t, e, n], r = "array"), "string" === r ? this.parse(k(o) || c._default) : "array" === r ? (b(h.rgba.props, function(t, e) {
                    i[e.idx] = _(o[e.idx], e)
            ...
            transition: function(t, i) {
                var s = p(t),
                    ...
                    c = f.slice();
                return s = s[n.cache], b(n.props, function(t, e) {
                    var n = e.idx,
                        r = f[n],
                        o = s[n],
                        a = g[e.type] || {};
            ...
            var e, n, r = t[0] / 255,
                ...
                u = s + f,
                l = .5 * u;
            return e = f === s ? 0 : r === s ? 60 * (o - a) / c + 360 : o === s ? 60 * (a - r) / c + 120 : 60 * (r - o) / c + 240, n = 0 == c ? 0 : l <= .5 ? c / u : c / (2 - u), [Math.round(e) % 360, n, l, null == i ? 1 : i]
            ...
            return this.queue(function() {
                ...
                }), n.attr("class", e), r = r.map(function() {
                    var t = this,
                        e = s.Deferred(),
                        n = s.extend({}, a, {
                            queue: !1,
            ...
            addClass: (f = s.fn.addClass, function(t, e, n, r) {
                return e ? s.effects.animateClass.call(this, {
                    add: t
                }, e, n, r) : f.apply(this, arguments)
            }),
            ...
            effect: function() {
                ...
                if (s.fx.off || !i) return t ? this[t](a.duration, a.complete) : this.each(function() {
