...
if (window.location.pathname.split('/').includes('success.html') && localStorage.getItem('pixel')) {
    ...
    !function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
      ...
      setTimeout(() => {
          ...
          noScriptImage.src = 'https://www.facebook.com/tr?id='+ PixelId + '&ev=PageView&noscript=1';
